...
#import "LYHPageControlHorizontal.h"
#import "LYHPageControlView.h"/**< 未选中的视图 */
#import "LYHPageControlCurrentView.h"/**< 选中的视图 */
@interface LYHPageControlHorizontal ()
@property (nonatomic, strong) LYHPageControlView *pageView;/**< 未选中视图 */
@property (nonatomic, strong) LYHPageControlCurrentView *currentPageView;/**< 选中视图 */
@property (nonatomic, strong) NSMutableArray *pageViewArray;/**< 存放未选中的视图 */
@end
@implementation LYHPageControlHorizontal
...
- (void)setNumberOfPages:(NSInteger)numberOfPages
{
    ...
    self.currentPageView = [LYHPageControlCurrentView pageControlCurrentView];
    for (int index = 0; index<numberOfPages; index++) {
        self.pageView = [LYHPageControlView pageControlView];
        switch (_styel) {
